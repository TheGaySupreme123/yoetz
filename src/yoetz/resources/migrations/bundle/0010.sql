...
-- Migration 0010 admits the lineage, work, and coordination event families that the
...
-- rewrite every dependent REFERENCES clause to `events_v10_old` even under legacy_alter_table.
--
...
DROP TABLE events;
ALTER TABLE events_v10_new RENAME TO events;
