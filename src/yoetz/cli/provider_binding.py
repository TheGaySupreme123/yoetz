"""Interactive nonsecret LLM endpoint binding for reviewed providers and owner-declared origins.
...
def prompt_provider_endpoint_binding(*, path: Path | None = None) -> Path | None:
    ...
    typer.echo("  6  Vercel AI Gateway (OpenAI-compatible Chat Completions)")
