...
_EXPECTED_MEMBER_COUNT = 52
_EXPECTED_REQUEST_RESULT_VERSION_COUNT = 31
...
def test_schema_registry_is_complete() -> None:
    ...
    assert all(member["schema_version"] == _EXPECTED_SCHEMA_MANIFEST_VERSION for member in members)
