"""Consent v2 public artifacts contain no agent-usable approval or secret transport."""
...
def test_live_agent_projection_contains_only_v2_structural_review_data(tmp_path: Path) -> None:
    rendered = json.dumps(
