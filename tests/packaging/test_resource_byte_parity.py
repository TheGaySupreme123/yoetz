...
Proves each of the 72 manifest-declared runtime resources is the exact reviewed byte set in the
...
def test_manifest_has_exactly_72_entries_with_the_reviewed_kind_counts() -> None:
