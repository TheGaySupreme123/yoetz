...
ledger, projections derive state from those events, and local checks plus optional advisory
AI-powered review produce receipts. Adapters (`src/yoetz/adapters/`) hold every host, git, SQLite,
...
- Do not weaken the honesty rules in [`CONTRIBUTING.md`](CONTRIBUTING.md). Coverage-bounded wording,
  ...
  deterministic reproducibility, fenced advisory AI-powered output, and independently authorized
