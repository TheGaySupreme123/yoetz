...
**ADRs:** ADR-001 through ADR-027 | **Related:** [`docs/INTERFACES.md`](INTERFACES.md),
...
- **F-021 (2026-07-22):** First-party Codex observation is in protocol `0.1` (not deferred to
  ...
  and retains already-kept evidence. That confirmation is the existing workspace observation
