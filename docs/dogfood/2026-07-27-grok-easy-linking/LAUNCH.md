...
| CODEX_HOME | `/Users/shayb/.codex-testing` |
...
kill -0 $(cat /tmp/codex-grok-easy-linking-20260727T164241Z/codex.pid) && echo running || echo done

# Tail events
tail -f /tmp/codex-grok-easy-linking-20260727T164241Z/codex-events.jsonl
