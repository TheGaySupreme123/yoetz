...
**Owning public specs:** `specs/INTERFACES.md`, `specs/src/yoetz_core/adapters/sqlite/`,
`specs/src/yoetz_core/ports/ledger.md`, `specs/src/yoetz_core/ports/runtime.md`, root and packaged
