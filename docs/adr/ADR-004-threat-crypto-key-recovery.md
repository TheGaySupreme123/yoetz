...
independent threat review before the first non-alpha release; the v0.1.0 public alpha ships
without that review by maintainer decision (2026-08-19, `docs/OPEN_QUESTIONS.md` R-001
disposition) and no public surface claims a reviewed design.
