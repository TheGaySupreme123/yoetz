...
check output in this host shows the directive. SessionStart and observe-hook advisories append
the same token after their host-specific prefix (issue #739). No Cursor-specific recovery
