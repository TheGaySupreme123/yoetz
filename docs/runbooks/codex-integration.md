...
SessionStart and observe-hook advisories append the same token after their host-specific prefix
(issue #739). No Codex-specific recovery wording is configured.
