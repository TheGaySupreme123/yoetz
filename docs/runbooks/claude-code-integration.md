...
directive appear there. Raw provider text never reaches that projection. SessionStart and
observe-hook advisories append the same token after their host-specific prefix (issue #739).
No Claude-specific recovery wording is configured.
