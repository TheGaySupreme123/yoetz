...
(`catalog_schema_version` `5`, `bundle_schema_version` `13` — hand-versioned positive-decimal
...
built with — currently catalog 5 and bundle 13 — reporting `migration_required` when the file is
