...
[`2026-07-22-second-dogfood-remediation-residuals.md`](2026-07-22-second-dogfood-remediation-residuals.md)
...
- Complete isolated Codex rollout:
  `$CODEX_TESTING_HOME/sessions/2026/07/22/rollout-2026-07-22T21-47-44-019f8b27-b98e-7061-bbb5-d0b897594de6.jsonl`.
- Terminal transcript:
  `/tmp/codex-testing-provider-endpoints-20260722-214656.typescript`.
- Current task ledger:
  `$YOETZ_DATA/tasks/tsk_24f56d5d-cdfc-4681-9fd4-a121147c9338/ledger.sqlite3`.
...
The installed `$HOME/.local/bin/yoetz` remained version `0.1.0` from before the generated
...
No Yoetz skill existed under `$CODEX_TESTING_HOME/skills` during the run. The packaged skill
manifest has:
