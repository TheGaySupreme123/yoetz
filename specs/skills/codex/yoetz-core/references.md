# skills/codex/yoetz-core/references/ — installed skill reference specifications
...
```text
skills/codex/yoetz-core/references/coverage-and-receipts.md
skills/codex/yoetz-core/references/publication-policy.md
```
