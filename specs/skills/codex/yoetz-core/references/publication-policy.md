# skills/codex/yoetz-core/references/publication-policy.md — Codex publication policy reference

**Wave:** D | **ADRs:** ADR-002, ADR-005 | **Imports (spec-tree):**
`specs/INTERFACES.md`, `specs/skills/codex/yoetz-core/SKILL.md` | **Imported by:** the installed
...
- `skills/codex/yoetz-core/references/publication-policy.md` — public markdown reference shipped
  beside the skill.
