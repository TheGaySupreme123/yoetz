# skills/codex/yoetz-core/SKILL.md — Codex cooperative-workflow skill specification
...
`skills/codex/yoetz-core/SKILL.md` and be copied byte-for-byte into the wheel before explicit
