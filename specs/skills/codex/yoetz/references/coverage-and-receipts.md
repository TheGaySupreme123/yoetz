# skills/codex/yoetz/references/coverage-and-receipts.md — Codex coverage and receipt reference

**Wave:** D | **ADRs:** ADR-002, ADR-005, ADR-007 | **Imports (spec-tree):**
`specs/INTERFACES.md`, `specs/src/yoetz/domain/receipts.md`,
`specs/src/yoetz/protocol/coverage.md` | **Imported by:** the installed Yoetz skill and
...
- `skills/codex/yoetz/references/coverage-and-receipts.md` — public markdown reference shipped
  beside the skill.
