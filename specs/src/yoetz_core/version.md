# src/yoetz_core/version.py — installed capability and version manifest
...
| `package_name`, `package_version` | `yoetz-core` and installed distribution metadata |
