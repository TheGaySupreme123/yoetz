# src/yoetz_core/adapters/objects/__init__.py — side-effect-free object-store package marker
...
Mark `yoetz_core.adapters.objects` as the package boundary for object-store and envelope helpers.
