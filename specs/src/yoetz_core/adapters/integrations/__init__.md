# src/yoetz_core/adapters/integrations/__init__.py — side-effect-free integration-adapter package marker
...
Mark `yoetz_core.adapters.integrations` as the package boundary for integration-specific adapter
helpers.
