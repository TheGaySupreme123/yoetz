# src/yoetz_core/adapters/sqlite/__init__.py — side-effect-free SQLite adapter package marker
...
Mark `yoetz_core.adapters.sqlite` as the package boundary for durable storage and recovery modules.
