# src/yoetz_core/adapters/sqlite/repository.py — LedgerPort over the task bundle database

**Wave:** C | **ADRs:** ADR-001, ADR-002, ADR-003 | **Imports (spec-tree):**
`specs/src/yoetz_core/adapters/sqlite/connection.md`,
`specs/src/yoetz_core/adapters/sqlite/migrations.md`,
`specs/src/yoetz_core/protocol/canonical.md`, `specs/src/yoetz_core/protocol/errors.md`,
`specs/src/yoetz_core/domain/events.md`, `specs/src/yoetz_core/kernel/reducers.md`,
`specs/src/yoetz_core/ports/ledger.md` | **Imported by:**
`specs/src/yoetz_core/application/service.md`, `specs/src/yoetz_core/application/check.md`,
...
append and check/semantic lease lifecycle owned by `specs/src/yoetz_core/ports/ledger.md` against
the schema owned by `specs/src/yoetz_core/resources/migrations/bundle/0001.sql.md`.
...
- `SqliteLedger` — implements the exact contract in
  `specs/src/yoetz_core/ports/ledger.md`:
...
- `rebuild_projection(projection_name) -> None` — generation-replay trigger owned with
  `specs/src/yoetz_core/kernel/projections.md`.
...
4. Verify the writer: row exists in `writers`, `state='active'`, and the command's claimed
   ...
   `specs/src/yoetz_core/ports/ledger.md`), never last-write-wins.
...
### Check-operation lifecycle (`specs/src/yoetz_core/application/check.md`)
...
`specs/src/yoetz_core/resources/migrations/bundle/0001.sql.md`; the orchestration lifecycle is
owned by `specs/src/yoetz_core/application/check.md`.
...
required by `specs/src/yoetz_core/ports/ledger.md`. For every row returned it re-verifies that the indexed columns
...
`specs/src/yoetz_core/kernel/projections.md`: verify identity,
