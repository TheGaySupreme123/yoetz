# src/yoetz_core/adapters/sqlite/start_catalog.py — StartCatalogPort over catalog.sqlite3
...
`specs/src/yoetz_core/protocol/canonical.md`, `specs/src/yoetz_core/protocol/ids.md`,
`specs/src/yoetz_core/ports/start_catalog.md`, `specs/src/yoetz_core/ports/keys.md` |
**Imported by:** `specs/src/yoetz_core/application/start.md`,
...
`specs/src/yoetz_core/ports/start_catalog.md`. It guarantees that one
...
- `SqliteStartCatalog(connection, *, installation_id, lookup: MacKeyHandle, ...)` — implements
  `specs/src/yoetz_core/ports/start_catalog.md`. Construction requires a ready-vault handle bound to
...
owned by `specs/src/yoetz_core/ports/start_catalog.md`, which receives it inside `StartCommand`.
