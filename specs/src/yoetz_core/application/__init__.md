# src/yoetz_core/application/__init__.py — side-effect-free application package marker
...
Mark `yoetz_core.application` as the package boundary for the use-case facade and support modules.
