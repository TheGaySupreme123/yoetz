# src/yoetz_core/application/service.py — ready-service application facade
...
The local receipt proves only what Core released across its service-to-client `agent_context`
