# src/yoetz_core/domain/__init__.py — side-effect-free domain package marker
...
Mark `yoetz_core.domain` as the package boundary for values, events, findings, and receipts.
