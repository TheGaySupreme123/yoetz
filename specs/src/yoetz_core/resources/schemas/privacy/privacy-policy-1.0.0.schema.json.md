# src/yoetz_core/resources/schemas/privacy/privacy-policy-1.0.0.schema.json — installed privacy-policy schema copy
...
- Installed path: `src/yoetz_core/resources/schemas/privacy/privacy-policy-1.0.0.schema.json`.
