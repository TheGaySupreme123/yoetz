# src/yoetz_core/resources/schemas/privacy/egress-receipt-1.0.0.schema.json — installed egress-receipt schema copy
...
- Installed path: `src/yoetz_core/resources/schemas/privacy/egress-receipt-1.0.0.schema.json`.
