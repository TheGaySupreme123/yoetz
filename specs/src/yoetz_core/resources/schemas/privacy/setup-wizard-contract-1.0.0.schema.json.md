# src/yoetz_core/resources/schemas/privacy/setup-wizard-contract-1.0.0.schema.json — installed privacy-setup schema copy
...
- Installed path: `src/yoetz_core/resources/schemas/privacy/setup-wizard-contract-1.0.0.schema.json`.
