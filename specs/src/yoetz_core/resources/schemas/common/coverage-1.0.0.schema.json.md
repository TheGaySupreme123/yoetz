# src/yoetz_core/resources/schemas/common/coverage-1.0.0.schema.json — installed byte-identical schema copy
...
- Installed package path: `src/yoetz_core/resources/schemas/common/coverage-1.0.0.schema.json`.
