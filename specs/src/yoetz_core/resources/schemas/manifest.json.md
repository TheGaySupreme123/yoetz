# src/yoetz_core/resources/schemas/manifest.json — installed byte-identical schema manifest copy

**Wave:** A/F | **ADRs:** ADR-002, ADR-003, ADR-006, ADR-007, ADR-008, ADR-009 |
**Imports (spec-tree):**
`specs/schemas/manifest.json.md`, `specs/src/yoetz_core/resources/manifest.json.md` |
...
- Installed package path: `src/yoetz_core/resources/schemas/manifest.json`.
