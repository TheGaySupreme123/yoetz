# src/yoetz_core/resources/fixtures/canonical/identifiers.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed identifier canonical fixture.

## Public surface

- Logical resource: `fixtures/canonical/identifiers.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/identifiers.case.json`.
