# src/yoetz_core/resources/fixtures/canonical/utf16-property-order.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed UTF-16 property-order canonical fixture.

## Public surface

- Logical resource: `fixtures/canonical/utf16-property-order.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/utf16-property-order.case.json`.
