# src/yoetz_core/resources/fixtures/canonical/restricted-json-rejections.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed restricted-JSON rejection canonical
fixture.

## Public surface

- Logical resource: `fixtures/canonical/restricted-json-rejections.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/restricted-json-rejections.case.json`.
