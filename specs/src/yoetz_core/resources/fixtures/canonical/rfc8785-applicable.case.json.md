# src/yoetz_core/resources/fixtures/canonical/rfc8785-applicable.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed RFC 8785 applicable canonical fixture.

## Public surface

- Logical resource: `fixtures/canonical/rfc8785-applicable.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/rfc8785-applicable.case.json`.
