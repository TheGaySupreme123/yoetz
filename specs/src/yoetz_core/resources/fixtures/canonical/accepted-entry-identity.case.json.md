# src/yoetz_core/resources/fixtures/canonical/accepted-entry-identity.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/accepted-entry-identity.case.json`.
