# src/yoetz_core/resources/fixtures/canonical/publication-request-identity.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed publication-request identity canonical
fixture.

## Public surface

- Logical resource: `fixtures/canonical/publication-request-identity.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/publication-request-identity.case.json`.
