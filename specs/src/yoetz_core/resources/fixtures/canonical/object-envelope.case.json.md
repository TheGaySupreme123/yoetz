# src/yoetz_core/resources/fixtures/canonical/object-envelope.case.json — installed canonical fixture copy
...
Specify the packaged byte-identical copy of the reviewed object-envelope canonical fixture.

## Public surface

- Logical resource: `fixtures/canonical/object-envelope.case.json`.
- Installed package path:
  `src/yoetz_core/resources/fixtures/canonical/object-envelope.case.json`.
