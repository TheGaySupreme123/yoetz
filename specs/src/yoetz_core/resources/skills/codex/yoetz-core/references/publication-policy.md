# src/yoetz_core/resources/skills/codex/yoetz-core/references/publication-policy.md — installed publication-policy reference

**Wave:** D | **ADRs:** ADR-002, ADR-005 | **Imports (spec-tree):**
`specs/skills/codex/yoetz-core/references/publication-policy.md`,
...
- Logical resource: `skills/codex/yoetz-core/references/publication-policy.md`.
- Installed package path: `src/yoetz_core/resources/skills/codex/yoetz-core/references/publication-policy.md`.
