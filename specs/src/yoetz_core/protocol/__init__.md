# src/yoetz_core/protocol/__init__.py — side-effect-free protocol package marker
...
Mark `yoetz_core.protocol` as the package boundary for canonicalization, IDs, coverage, schemas,
and error handling.
