# src/yoetz_core/protocol/ids.py — typed public identifier kinds, generation, and validation
...
5. The 36-char remainder matches canonical UUID spelling: lowercase hex `[0-9a-f]` in groups
   ...
   here; `specs/src/yoetz_core/protocol/canonical.md` requires one lowercase spelling only.
...
`specs/src/yoetz_core/mcp/server.md`. Behavior:
