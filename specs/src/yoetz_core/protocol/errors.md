# src/yoetz_core/protocol/errors.py — public error codes and bounded protocol errors
...
The exact adapter mappings are owned by `specs/src/yoetz_core/cli/exits.md` and
`specs/src/yoetz_core/mcp/errors.md` and must stay stable across transports.
