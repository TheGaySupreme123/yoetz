# src/yoetz_core/config/paths.py — platform paths and bundle path safety gate

**Wave:** C | **ADRs:** ADR-003 | **Imports (spec-tree):** `specs/src/yoetz_core/config/models.md`
(for `StorageConfig`) | **Imported by:** `specs/src/yoetz_core/adapters/sqlite/connection.md`,
`specs/src/yoetz_core/adapters/objects/encrypted_files.md`,
`specs/src/yoetz_core/application/service.md`, `specs/src/yoetz_core/config/load.md`
