# src/yoetz_core/kernel/ranking.py — stable ordering and verdict selection for findings
...
the rest of Yoetz Core shows to users. It is the policy-aware ordering layer between raw findings
