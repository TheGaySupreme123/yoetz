# src/yoetz_core/kernel/__init__.py — side-effect-free kernel package marker
...
Mark `yoetz_core.kernel` as the package boundary for reducers, ranking, receipt building, and
