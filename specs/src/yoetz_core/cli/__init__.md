# src/yoetz_core/cli/__init__.py — side-effect-free CLI package marker
...
Mark `yoetz_core.cli` as the package boundary for command-line entrypoints and rendering helpers.
