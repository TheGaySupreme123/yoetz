# src/yoetz_core/ports/privacy.py — privacy policy, audit, human-control, and outbound gateway ports
...
Define the only effect boundaries through which Core may load/change privacy policy, persist a
