# src/yoetz_core/ports/integrations.py — explicit external-tool integration filesystem boundary
...
Target scope is exactly `<trusted-project>/.agents/skills/yoetz-core/`. The project root is supplied
