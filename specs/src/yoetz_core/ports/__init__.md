# src/yoetz_core/ports/__init__.py — side-effect-free ports package marker
...
Mark `yoetz_core.ports` as the package boundary for the abstract port interfaces used by the
