# src/yoetz_core/ports/start_catalog.py — StartCatalogPort protocol for pre-writer start allocation
...
`specs/src/yoetz_core/application/start.md` in one catalog `BEGIN IMMEDIATE`-equivalent atomic section:
