# src/yoetz/observability/__init__.py — side-effect-free observability package marker
...
Mark `yoetz.observability` as the package boundary for logging and privacy controls.
