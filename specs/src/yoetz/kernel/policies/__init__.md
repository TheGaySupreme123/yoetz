# src/yoetz/kernel/policies/__init__.py — side-effect-free policy-pack package marker
...
Mark `yoetz.kernel.policies` as the package boundary for the frozen policy packs.
