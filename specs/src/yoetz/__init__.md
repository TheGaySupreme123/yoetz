# src/yoetz/__init__.py — side-effect-free package boundary
...
Define the deliberately tiny import surface of `yoetz`. Importing the package must be safe in
...
1. `import yoetz` has no filesystem writes, network calls, subprocesses, logging configuration,
