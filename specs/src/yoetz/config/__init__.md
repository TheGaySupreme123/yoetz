# src/yoetz/config/__init__.py — side-effect-free config package marker
...
Mark `yoetz.config` as the package boundary for configuration models, load rules, and paths.
