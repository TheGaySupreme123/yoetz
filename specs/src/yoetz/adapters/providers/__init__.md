# src/yoetz/adapters/providers/__init__.py — side-effect-free provider package marker
...
Mark `yoetz.adapters.providers` as the package boundary for provider implementations owned
