# src/yoetz/adapters/memory/__init__.py — side-effect-free in-memory adapter package marker
...
Mark `yoetz.adapters.memory` as the package boundary for in-memory test/runtime adapters.
