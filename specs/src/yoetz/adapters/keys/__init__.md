# src/yoetz/adapters/keys/__init__.py — side-effect-free key-backend package marker
...
Mark `yoetz.adapters.keys` as the package boundary for backend-specific key handling.
