# src/yoetz/adapters/__init__.py — side-effect-free adapter package marker
...
Mark `yoetz.adapters` as a regular package boundary without turning package import into an
