# src/yoetz/adapters/importers/__init__.py — side-effect-free importer package marker
...
Mark `yoetz.adapters.importers` as a regular package boundary for importer-specific modules.
