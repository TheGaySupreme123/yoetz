# src/yoetz/application/privacy_policy.py — privacy setup and policy-transition use cases
...
Yoetz local-disclosure receipt cannot attest that host's later egress or retention. Authenticated
