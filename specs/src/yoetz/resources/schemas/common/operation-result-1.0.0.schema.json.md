# src/yoetz/resources/schemas/common/operation-result-1.0.0.schema.json — installed byte-identical schema copy
...
- Installed package path: `src/yoetz/resources/schemas/common/operation-result-1.0.0.schema.json`.
