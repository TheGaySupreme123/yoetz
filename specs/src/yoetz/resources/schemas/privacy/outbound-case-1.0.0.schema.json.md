# src/yoetz/resources/schemas/privacy/outbound-case-1.0.0.schema.json — installed outbound-case schema copy
...
- Installed path: `src/yoetz/resources/schemas/privacy/outbound-case-1.0.0.schema.json`.
