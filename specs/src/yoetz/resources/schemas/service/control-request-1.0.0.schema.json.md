# src/yoetz/resources/schemas/service/control-request-1.0.0.schema.json — installed control-request schema copy
...
artifact's complete thirty-call-plus-cancel union offline. The six workflow body `$ref`s
