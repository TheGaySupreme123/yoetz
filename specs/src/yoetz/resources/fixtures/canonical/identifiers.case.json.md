# src/yoetz/resources/fixtures/canonical/identifiers.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/identifiers.case.json`.
