# src/yoetz/resources/fixtures/canonical/object-envelope.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/object-envelope.case.json`.
