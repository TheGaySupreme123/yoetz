# src/yoetz/resources/fixtures/canonical/rfc8785-applicable.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/rfc8785-applicable.case.json`.
