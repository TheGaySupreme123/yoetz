# src/yoetz/resources/fixtures/canonical/restricted-json-rejections.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/restricted-json-rejections.case.json`.
