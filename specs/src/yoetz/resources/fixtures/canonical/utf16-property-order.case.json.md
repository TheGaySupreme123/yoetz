# src/yoetz/resources/fixtures/canonical/utf16-property-order.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/utf16-property-order.case.json`.
