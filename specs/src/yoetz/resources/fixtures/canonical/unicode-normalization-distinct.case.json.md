# src/yoetz/resources/fixtures/canonical/unicode-normalization-distinct.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/unicode-normalization-distinct.case.json`.
