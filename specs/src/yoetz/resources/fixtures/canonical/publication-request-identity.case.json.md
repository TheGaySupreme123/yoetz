# src/yoetz/resources/fixtures/canonical/publication-request-identity.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/publication-request-identity.case.json`.
