# src/yoetz/resources/fixtures/canonical/restricted-json-positive.case.json — installed canonical fixture copy
...
- Installed package path:
  `src/yoetz/resources/fixtures/canonical/restricted-json-positive.case.json`.
