# src/yoetz/resources/skills/codex/yoetz/references/coverage-and-receipts.md — installed coverage-and-receipts reference

**Wave:** D | **ADRs:** ADR-002, ADR-005, ADR-007 | **Imports (spec-tree):**
`specs/skills/codex/yoetz/references/coverage-and-receipts.md`,
...
- Logical resource: `skills/codex/yoetz/references/coverage-and-receipts.md`.
- Installed package path: `src/yoetz/resources/skills/codex/yoetz/references/coverage-and-receipts.md`.
