...
The manifest is the canonical inventory. At this draft checkpoint it classifies 560 spec files:
546 unique future-file owners, 10 directory indexes, and 4 coordination files. Every future owner
...
| Repository root | 15 | — |
| `.github/` workflows | 9 | — |
| `docs/` public protocol and runbooks | 11 | The thirteen already-authored ADRs remain current authorities outside the future-file universe. |
...
| `src/yoetz/` Python/code files | 136 | — |
| `src/yoetz/resources/` | 72 | The resource manifest plus exactly 71 installed entries. |
| `scripts/` | 6 | — |
| `tests/` | 183 | 7 suite indexes |
| **Total future files** | **546** | **10 indexes + 4 coordination files = 560 spec files** |
