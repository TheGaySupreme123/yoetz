...
The manifest is the canonical inventory. At this draft checkpoint it classifies 576 spec files:
562 unique future-file owners, 10 directory indexes, and 4 coordination files. Every future owner
...
| `src/yoetz/` Python/code files | 144 | — |
| `src/yoetz/resources/` | 72 | The resource manifest plus exactly 71 installed entries. |
| `scripts/` | 6 | — |
| `tests/` | 191 | 7 suite indexes |
| **Total future files** | **562** | **10 indexes + 4 coordination files = 576 spec files** |
