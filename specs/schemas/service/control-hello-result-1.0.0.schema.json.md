...
and drawn only from the ASCII-sorted registry `backup_execute`, `backup_preview`, `check`,
...
integration, lifecycle and privacy support methods are neither advertised nor accepted. The four
