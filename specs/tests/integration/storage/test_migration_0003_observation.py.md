...
Prove schema-2 upgrade, schema-3 restart/copy restore, and atomic failed-followup rollback.
...
Build an authentic schema-2 bundle, apply registry migration, reopen/copy it, and verify identity,
integrity, metadata, and all migration-3 tables. Inject a failing migration 4 and prove rollback.
