...
`specs/src/yoetz_core/kernel/projections.md` | **Imported by:**
`specs/src/yoetz_core/resources/migrations/bundle/0001.sql.md`,
...
`specs/src/yoetz_core/adapters/sqlite/importer.md`; neither implementation may synthesize tables
